...
<html>
  <head>
    ...
    <script src="js/test_key.js"> </script>
  </head>
   <body>    
		<?php 
			if(isset($_GET['page'])){
				...
				<div class="row-fluid <?php echo isset($_SESSION['user'])?'below-header':'';?>">
						...
						<?php 	if(isset($_SESSION['user']) && $_SESSION['user_type'] != "Administrator") {?>
							<div class ="span7 menu">
								<div class="menu-item <?php echo isset($_GET['page'])?$_GET['page']=='add_announcement'?'active':'':''; ?>">
									<a <?php $sub = $_SESSION['user_type']=='Teacher'?'add_announcement':'home'; echo isset($_GET['page'])&&$_GET['page']==$sub?'class="active"':''; ?> href="?page=home">Home</a>
								</div>
								<div class="menu-item">
									<a <?php echo isset($_GET['page'])&&$_GET['page']=='tests'?'class="active"':''; ?> href="?page=tests">Tests</a>
								</div>
								<div class="menu-item">
									 <a <?php echo isset($_GET['page'])&&$_GET['page']=='classlists'?'class="active"':''; ?> href="?page=classlists">Classlists</a>
								</div>
								<div class="menu-item">
					...
					<!-------------------------------------------------FORUM NAVIGATOR-------------------------------------------------------------------->
						...
						<?php } ?>
							...
							<!-----------------------------------------END MODAL-------------------------------------------------->
							<!----------------------------------------MODAL FOR EXAM-------------------------------------------------->
							<div id="taking_exam" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="taking_exam" aria-hidden="true">	
								<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									<h4>You take exam.</h4>
								</div>
								...
								<div class="modal-footer">
										<input type="submit" value="Ok." onclick="okClicked(); " />
									</form>
								</div>
							</div>
							<!-----------------------------------------END MODAL-------------------------------------------------->
